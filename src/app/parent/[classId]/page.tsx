  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pb-12">
      ...
      <div className="bg-indigo-600 text-white px-4 py-6 shadow-md sticky top-0 z-10">
        <div className="text-center mb-1"><span className="bg-indigo-800 text-xs px-2 py-1 rounded-full font-semibold uppercase tracking-wider">Parent Portal</span></div>
